// ============================================
// product-disk-navigation.js - VERSION SIMPLIFIÉE
// UNIQUEMENT pour products_disk.html (page listing)
...
if (window.location.pathname.includes('product_disk-detail.html')) {
    console.log('⏩ Page détail détectée, product-disk-navigation.js désactivé');
} else {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        console.log('🚀 product-disk-navigation.js - Initialisation (page listing)');
    ...
    console.log('✅ product-disk-navigation.js chargé (PAGE LISTING uniquement)');
}