            ...
            <div class="product-detail-right">
                <div class="product-info-box">
                    ...
                    <div class="color-selection-area">
                        <h3 class="color-selection-title">Choisissez un format</h3>
                        <div class="color-options-row">
                            ...
                            <div class="color-option" data-color="Blanc" style="background-color: #E8E8E8;"></div>
                            <div class="color-option" data-color="Gris" style="background-color: #7D8F9B;"></div>
                        </div>
                        <span class="selected-color-text">Format sélectionné: <span id="selected-color">Argent</span></span>
                    </div>
...
<script src="{{ asset('assets/js/pagination-detail-disk.js') }}"></script>
</body>
@endsection
